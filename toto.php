...
<div class="gd-lotto border border-dark" style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%)">
    <div class="text-center mt-5">
        <h1 class="border border-danger d-inline-block bg-primary p-3">ToTo-4D</h1>
    </div>
    <div class="text-center">
        <h3 class="border border-danger d-inline-block bg-success text-white p-3">1ST PRIZE NUMBER</h3>
    </div>

    <div class="text-center mt-5">
		
        <input style="height: 50px; font-size: 20px; outline: none;text-align:center;" class="border border-danger" type="text" value="<?php echo $postDetail[100] ?>" name="lottoNumber" id="lottoNumber" readonly>
    </div>
